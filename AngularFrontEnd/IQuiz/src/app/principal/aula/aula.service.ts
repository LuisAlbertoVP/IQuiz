...
export class AulaService {
  apiExplorer: string = 'http://localhost:8001/explorer-aula/aulas';
  apiAsignacion: string = 'http://localhost:8003/asignacion-administracion/cursos';
  apiPost: string = 'http://localhost:8003/post-administracion/cursos';
  ...
  addPostComentario = (id: string, post: Post) => this.http.post(`http://localhost:8003/post-administracion/posts/${id}/comentarios`, post, httpOptions)
      .pipe(catchError(this.handleError('addCursoPost', post)));
}
